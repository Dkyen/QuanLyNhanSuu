...
namespace QLNhanSu
{
    public partial class frmNhanVien_ThoiViec : DevExpress.XtraEditors.XtraForm
    {
        ...
        void _showHide(bool tv)
        {
            ...
            btnDong.Enabled = tv;
            btnIn.Enabled = tv;
            gcDanhSach.Enabled = tv;
            txtSoQD.Enabled = !tv;
            txtLyDo.Enabled = !tv;
            txtGhiChu.Enabled = !tv;
       
            slkNhanVien.Enabled = !tv;
            dtNgayNopDon.Enabled=!tv;
        ...
        /*private void gvDanhSach_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            ...
            {
                //Image img = Properties.Resources.delete_icon1;
